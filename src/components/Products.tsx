      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 border border-white/6">
          {PRODUCTS_DATA.map((p, i) => (
            <motion.div
              key={i}
              className="group bg-[#0a0a08] hover:bg-white/5 transition-all duration-300 flex flex-col border border-white/6 overflow-hidden"
            ...
            >
              ...
              {p.video ? (
                <div 
                  className="relative h-64 md:h-80 bg-white/3 border-b border-white/6 overflow-hidden cursor-pointer group"
